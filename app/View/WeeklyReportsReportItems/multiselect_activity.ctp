<?php ?>
<!-- File: app/View/WeeklyReportsReportItems/multiselect_activity.ctp -->
<div class="top">
	<h1><?php echo __('Assign all selected %s to %s %s', __('Report Items'), 'an', __('Activity')); ?></h1>
</div>
<div class="center">
	<div class="posts form">
	<?php echo $this->Form->create('WeeklyReportsReportItem', array('url' => array('action' => 'multiselect_activity')));?>
	    <fieldset>
