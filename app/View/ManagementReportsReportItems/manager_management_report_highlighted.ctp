<?php 
// File: app/View/ManagementReportsReportItems/manager_management_report_highlighted.ctp
...
if($owner)
{
	...
	$page_options[] = $this->Html->link(__('Send Needs Review Email'), array('action' => 'needs_review_email', $management_report['ManagementReport']['id']));
}
...
echo $this->element('Utilities.page_index', array(
	'page_title' => __('Highlighted %s %s', __('Staff'), __('Report Items')),
	'page_subtitle' => $management_report['ManagementReport']['staff_title'],
	'page_description' => $management_report['ManagementReport']['staff_text'],
