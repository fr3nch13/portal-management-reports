...
$th = array(
	...
	'ManagementReportsReportItem.item_state' => array('content' => __('%s %s', __('Item'), __('State')), 'options' => array('sort' => 'ManagementReportsReportItem.item_state', 'editable' => array('type' => 'select', 'required' => true, 'options' => $this->Local->getSortableStates()) )),
...
echo $this->element('Utilities.page_index', array(
	'page_title' => __('%s %s in need of Review', __('Management Report'), __('Items')),
