...
$page_options[] = $this->Html->link(__('View as if Finalized %s', __('Report')), array('action' => 'finalize', $weekly_report['WeeklyReport']['id']));

$details = array(
	array('name' => __('Owner'), 'value' => $weekly_report['User']['name']),
...
$stats[] = array(
	...
	'ajax_count_url' => array('controller' => 'weekly_reports_report_items', 'action' => 'weekly_report_table', $weekly_report['WeeklyReport']['id']),
