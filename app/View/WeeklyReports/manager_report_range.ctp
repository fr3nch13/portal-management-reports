...
$th = array(
	...
	'report_item_count' => array('content' => __('Item Count')),
...
{
	$td[$i] = array(
		$this->Html->link($weekly_report['WeeklyReport']['name'], array('action' => 'view', $weekly_report['WeeklyReport']['id']), array('target' => 'weekly_report_view')),
		$weekly_report['WeeklyReport']['report_item_count'],
...
//		$this->Wrap->niceTime($weekly_report['WeeklyReport']['created']),
		'multiselect' => $weekly_report['WeeklyReport']['id'],
	);
}
